...
export default function AdminSidebar({ user, adminProfile }) {
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="border-t border-gray-200 p-4">
            ...
            <div className="flex gap-2">
              <Link
                href="/"
                className="flex-1 px-3 py-2 text-xs font-medium text-center text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors"
              >
                View Site
              </Link>
              <button
                onClick={handleSignOut}
                className="flex-1 px-3 py-2 text-xs font-medium text-center text-red-700 bg-red-50 rounded-lg hover:bg-red-100 transition-colors"
              >
                Sign Out
              </button>
            </div>
